...
├── private/
│   ├── mail-private.el.example # Template for your credentials
...
#+BEGIN_SRC bash
cd ~/.emacs.d/private
cp mail-private.el.example mail-private.el
#+END_SRC
...
- ~~/.emacs.d/private/mail-private.el.example~ - Private config template
...
□ Copy mail-private.el.example → mail-private.el
